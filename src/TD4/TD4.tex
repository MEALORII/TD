...
On suppose le champ d'endommagement libre aux bords. A l'instant $t_i=
...
%          1, le déplacement est nul en tout point ($u=0$).
  ...
  \begin{solution}
      ...
      $$
  \end{solution}
    \question Pour un chargement monotone croissant $t$ à partir d'un état initial $\alpha_0=0$, donner l'évolution de l'endommagement et de la contrainte $\sigma$ avec $t$ pour les modèles $\mathsf{AT_1}$ et $\mathsf{AT_2}$. 
...
%	      \newline\underline{\textbf{Réponse 7:}}\vskip 5cm
	...
	\question  Étant donné les propriétés matérielles du béton : $E_0=30\,
