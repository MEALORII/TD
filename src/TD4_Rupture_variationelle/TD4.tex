   ...
   \end{cases}
    ...
    $\mathsf{AT_2}$ est adoucissant pour tout $\alpha >1/2$ et durcissant pour $\alpha <1/2$.    
     ...
     Montrer que les réponses $\sigma-t$ sont cohérentes avec les réponses précédentes.
      ...
      \jb{Sans faire la question précédente, je mettrai plutôt. Indiquer à quel modèle correspond chaque courbe et identifier les zones à régime durcissant/adoucissant en contraintes. Que vaut la contrainte maximale $\sigma_M$ pour le modèle $\mathsf{AT_1}$ ?}
%\end{questions}
...
\question \jb{Ne pas faire cette question ?} Montrer que les solutions doivent vérifier l'intégrale première suivante :
    ...
    0$ et
     ...
     Montrer que  $w(\alpha) -
                ...
                =0
                 $$
                 où l'égalité au lieu de l'inégalité provient du fait qu'on cherche une solution où, soit $\alpha'(x)=0$ (en dehors de la zone de localisation), soit $\alpha'(x)>0$ dans la zone de localisation. En multipliant par $\alpha'(x)$, on voit que:
                 $$ 
